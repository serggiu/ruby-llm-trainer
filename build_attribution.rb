...
#
# Usage:
#   ruby build_attribution.rb [sources_dir] [output.md]
#
# Defaults: _sources/ and Attribution.md relative to this script.

require "open3"

SOURCES_ROOT = File.expand_path(ARGV[0] || File.join(__dir__, "_sources"))
OUTPUT       = File.expand_path(ARGV[1] || File.join(__dir__, "Attribution.md"))
